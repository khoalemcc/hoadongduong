...
def create_default_users():
    ...
    try:
        ...
        # Đặt lại mật khẩu (cập nhật) cho admin
        admin_user.password_hash = models.User.password_hash.from_callable(admin_password)
        ...
        if not cust_user:
            cust_user = models.User(
                email=cust_email,
                password_hash=models.User.password_hash.from_callable(cust_password),
